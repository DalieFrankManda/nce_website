...
$queryMatAgr = "SELECT COUNT(*) AS totalMatAgr FROM mat_agr";
$queryTotalMatAgr = mysqli_query($connect, $queryMatAgr);
while($rowMatAgr = mysqli_fetch_assoc($queryTotalMatAgr)){
  $numOfMatAgr = $rowMatAgr['totalMatAgr'];
}

$queryfinaleSos = "SELECT COUNT(*) AS finaleSos FROM mat_agr WHERE yearofstudy = 'Fourth' OR yearofstudy = 'Third'";
...
$queryfinale = "SELECT COUNT(*) AS finale FROM mat_agr WHERE yearofstudy = 'Fourth'";
...
$queryassociate = "SELECT COUNT(*) AS associate FROM mat_agr WHERE yearofstudy = 'Third'";
...
$querycontiYearo = "SELECT COUNT(*) AS contiYearo FROM mat_agr WHERE yearofstudy = 'Second' OR yearofstudy = 'First'";
...
$queryconti = "SELECT COUNT(*) AS conti FROM mat_agr WHERE yearofstudy = 'Second'";
...
$queryyearo = "SELECT COUNT(*) AS yearo FROM mat_agr WHERE yearofstudy = 'First'";
    ...
    <div class="container">
      ...
      <main>
          ...
          <div class="sales">
            ...
            <div class="middle">
              ...
              <div class="progress">
                ...
                <div class="number">
                  <p><?php echo "$numOfMatAgr" ?></p>
                </div>
              </div>
            </div>

            <small class="text-muted">There are <b><?php echo "$numOfMatAgr" ?></b> Mat-Agr students currently registered for the examination</small>
          </div>
        ...
        <div class="recent-orders">
          <h2>Registered Mat-Agr Students</h2>
          <table>
            <thead>
              <tr>
                <th></th>
            ...
            <?php
              ...
              $sql = "SELECT * FROM  mat_agr LIMIT 0,5";
        ...
        <center>
          <div class="date">
            ...
            <span><a href="../admin/mat_agr.php"> <b>SHOW DETAILS</b> </a></span>
