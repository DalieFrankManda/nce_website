...
$queryMatChem = "SELECT COUNT(*) AS totalMatChem FROM mat_chem";
$queryTotalMatChem = mysqli_query($connect, $queryMatChem);
while($rowMatChem = mysqli_fetch_assoc($queryTotalMatChem)){
  $numOfMatChem = $rowMatChem['totalMatChem'];
}

$queryfinaleSos = "SELECT COUNT(*) AS finaleSos FROM mat_chem WHERE yearofstudy = 'Fourth' OR yearofstudy = 'Third'";
...
$queryfinale = "SELECT COUNT(*) AS finale FROM mat_chem WHERE yearofstudy = 'Fourth'";
...
$queryassociate = "SELECT COUNT(*) AS associate FROM mat_chem WHERE yearofstudy = 'Third'";
...
$querycontiYearo = "SELECT COUNT(*) AS contiYearo FROM mat_chem WHERE yearofstudy = 'Second' OR yearofstudy = 'First'";
...
$queryconti = "SELECT COUNT(*) AS conti FROM mat_chem WHERE yearofstudy = 'Second'";
...
$queryyearo = "SELECT COUNT(*) AS yearo FROM mat_chem WHERE yearofstudy = 'First'";
      ...
      <main>
        ...
        <div class="insights">
          <div class="sales">
            ...
            <div class="middle">
              <div class="left">
                <h3>Total Mat-Chem</h3>
                <h1><?php echo "$numOfMatChem" ?></h1>
              </div>
              ...
              <div class="progress">
                ...
                <div class="number">
                  <p><?php echo "$numOfMatChem" ?></p>
                </div>
              </div>
            </div>

            <small class="text-muted">There are <b><?php echo "$numOfMatChem" ?></b> Mat-Chem students currently registered for the examination</small>
          </div>
        ...
        <div class="recent-orders">
          <h2>Registered Mat-Chem Students</h2>
          <table>
            <thead>
              <tr>
                <th></th>
            ...
            <?php
              ...
              $sql = "SELECT * FROM  mat_chem LIMIT 0,5";
        ...
        <center>
          <div class="date">
            ...
            <span><a href="../admin/mat_chem.php"> <b>SHOW DETAILS</b> </a></span>
