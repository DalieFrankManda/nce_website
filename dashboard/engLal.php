...
$queryEngLal = "SELECT COUNT(*) AS totalEngLal FROM eng_lal";
$queryTotalEngLal = mysqli_query($connect, $queryEngLal);
while($rowEngLal = mysqli_fetch_assoc($queryTotalEngLal)){
  $numOfEngLal = $rowEngLal['totalEngLal'];
}

$queryfinaleSos = "SELECT COUNT(*) AS finaleSos FROM eng_lal WHERE yearofstudy = 'Fourth' OR yearofstudy = 'Third'";
...
$queryfinale = "SELECT COUNT(*) AS finale FROM eng_lal WHERE yearofstudy = 'Fourth'";
...
$queryassociate = "SELECT COUNT(*) AS associate FROM eng_lal WHERE yearofstudy = 'Third'";
...
$querycontiYearo = "SELECT COUNT(*) AS contiYearo FROM eng_lal WHERE yearofstudy = 'Second' OR yearofstudy = 'First'";
...
$queryconti = "SELECT COUNT(*) AS conti FROM eng_lal WHERE yearofstudy = 'Second'";
...
$queryyearo = "SELECT COUNT(*) AS yearo FROM eng_lal WHERE yearofstudy = 'First'";
    ...
    <div class="container">
      ...
      <main>
          ...
          <div class="sales">
            ...
            <div class="middle">
              ...
              <div class="progress">
                ...
                <div class="number">
                  <p><?php echo "$numOfEngLal" ?></p>
                </div>
              </div>
            </div>

            <small class="text-muted">There are <b><?php echo "$numOfEngLal" ?></b> Eng-Lal students currently registered for the examination</small>
          </div>
        ...
        <div class="recent-orders">
          <h2>Registered Eng-Lal Students</h2>
          <table>
            <thead>
              <tr>
                <th></th>
            ...
            <?php
              ...
              $sql = "SELECT * FROM  eng_lal LIMIT 0,5";
        ...
        <center>
          <div class="date">
            ...
            <span><a href="../admin/eng_lal.php"> <b>SHOW DETAILS</b> </a></span>
