...
$queryHecBio = "SELECT COUNT(*) AS totalHecBio FROM hec_bio";
$queryTotalHecBio = mysqli_query($connect, $queryHecBio);
while($rowHecBio = mysqli_fetch_assoc($queryTotalHecBio)){
  $numOfHecBio = $rowHecBio['totalHecBio'];
}

$queryfinaleSos = "SELECT COUNT(*) AS finaleSos FROM hec_bio WHERE yearofstudy = 'Fourth' OR yearofstudy = 'Third'";
...
$queryfinale = "SELECT COUNT(*) AS finale FROM hec_bio WHERE yearofstudy = 'Fourth'";
...
$queryassociate = "SELECT COUNT(*) AS associate FROM hec_bio WHERE yearofstudy = 'Third'";
...
$querycontiYearo = "SELECT COUNT(*) AS contiYearo FROM hec_bio WHERE yearofstudy = 'Second' OR yearofstudy = 'First'";
...
$queryconti = "SELECT COUNT(*) AS conti FROM hec_bio WHERE yearofstudy = 'Second'";
...
$queryyearo = "SELECT COUNT(*) AS yearo FROM hec_bio WHERE yearofstudy = 'First'";
    ...
    <div class="container">
      ...
      <main>
          ...
          <div class="sales">
            ...
            <div class="middle">
              ...
              <div class="progress">
                ...
                <div class="number">
                  <p><?php echo "$numOfHecBio" ?></p>
                </div>
              </div>
            </div>

            <small class="text-muted">There are <b><?php echo "$numOfHecBio" ?></b> Hec-Bio students currently registered for the examination</small>
          </div>
        ...
        <div class="recent-orders">
          <h2>Registered Hec-Bio Students</h2>
          <table>
            <thead>
              <tr>
                <th></th>
            ...
            <?php
              ...
              $sql = "SELECT * FROM  hec_bio LIMIT 0,5";
        ...
        <center>
          <div class="date">
            ...
            <span><a href="../admin/hec_bio.php"> <b>SHOW DETAILS</b> </a></span>
