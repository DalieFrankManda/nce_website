...
$queryMatBio = "SELECT COUNT(*) AS totalMatBio FROM mat_bio";
$queryTotalMatBio = mysqli_query($connect, $queryMatBio);
while($rowMatBio = mysqli_fetch_assoc($queryTotalMatBio)){
  $numOfMatBio = $rowMatBio['totalMatBio'];
}

$queryfinaleSos = "SELECT COUNT(*) AS finaleSos FROM mat_bio WHERE yearofstudy = 'Fourth' OR yearofstudy = 'Third'";
...
$queryfinale = "SELECT COUNT(*) AS finale FROM mat_bio WHERE yearofstudy = 'Fourth'";
...
$queryassociate = "SELECT COUNT(*) AS associate FROM mat_bio WHERE yearofstudy = 'Third'";
...
$querycontiYearo = "SELECT COUNT(*) AS contiYearo FROM mat_bio WHERE yearofstudy = 'Second' OR yearofstudy = 'First'";
...
$queryconti = "SELECT COUNT(*) AS conti FROM mat_bio WHERE yearofstudy = 'Second'";
...
$queryyearo = "SELECT COUNT(*) AS yearo FROM mat_bio WHERE yearofstudy = 'First'";
    ...
    <div class="container">
      ...
      <main>
          ...
          <div class="sales">
            ...
            <div class="middle">
              ...
              <div class="progress">
                ...
                <div class="number">
                  <p><?php echo "$numOfMatBio" ?></p>
                </div>
              </div>
            </div>

            <small class="text-muted">There are <b><?php echo "$numOfMatBio" ?></b> Mat-Bio students currently registered for the examination</small>
          </div>
        ...
        <div class="recent-orders">
          <h2>Registered Mat-Bio Students</h2>
          <table>
            <thead>
              <tr>
                <th></th>
            ...
            <?php
              ...
              $sql = "SELECT * FROM  mat_bio LIMIT 0,5";
        ...
        <center>
          <div class="date">
            ...
            <span><a href="../admin/mat_bio.php"> <b>SHOW DETAILS</b> </a></span>
