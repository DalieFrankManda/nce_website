...
$queryMatCom = "SELECT COUNT(*) AS totalMatCom FROM mat_com";
$queryTotalMatCom = mysqli_query($connect, $queryMatCom);
while($rowMatCom = mysqli_fetch_assoc($queryTotalMatCom)){
  $numOfMatCom = $rowMatCom['totalMatCom'];
}

$queryfinaleSos = "SELECT COUNT(*) AS finaleSos FROM mat_com WHERE yearofstudy = 'Fourth' OR yearofstudy = 'Third'";
...
$queryfinale = "SELECT COUNT(*) AS finale FROM mat_com WHERE yearofstudy = 'Fourth'";
...
$queryassociate = "SELECT COUNT(*) AS associate FROM mat_com WHERE yearofstudy = 'Third'";
...
$querycontiYearo = "SELECT COUNT(*) AS contiYearo FROM mat_com WHERE yearofstudy = 'Second' OR yearofstudy = 'First'";
...
$queryconti = "SELECT COUNT(*) AS conti FROM mat_com WHERE yearofstudy = 'Second'";
...
$queryyearo = "SELECT COUNT(*) AS yearo FROM mat_com WHERE yearofstudy = 'First'";
    ...
    <div class="container">
      ...
      <main>
          ...
          <div class="sales">
            ...
            <div class="middle">
              ...
              <div class="progress">
                ...
                <div class="number">
                  <p><?php echo "$numOfMatCom" ?></p>
                </div>
              </div>
            </div>

            <small class="text-muted">There are <b><?php echo "$numOfMatCom" ?></b> Mat-Com students currently registered for the examination</small>
          </div>
        ...
        <div class="recent-orders">
          <h2>Registered Mat-Com Students</h2>
          <table>
            <thead>
              <tr>
                <th></th>
            ...
            <?php
              ...
              $sql = "SELECT * FROM  mat_com LIMIT 0,5";
        ...
        <center>
          <div class="date">
            ...
            <span><a href="../admin/mat_com.php"> <b>SHOW DETAILS</b> </a></span>
