...
$queryMatPhy = "SELECT COUNT(*) AS totalMatPhy FROM mat_phy";
$queryTotalMatPhy = mysqli_query($connect, $queryMatPhy);
while($rowMatPhy = mysqli_fetch_assoc($queryTotalMatPhy)){
  $numOfMatPhy = $rowMatPhy['totalMatPhy'];
}

$queryfinaleSos = "SELECT COUNT(*) AS finaleSos FROM mat_phy WHERE yearofstudy = 'Fourth' OR yearofstudy = 'Third'";
...
$queryfinale = "SELECT COUNT(*) AS finale FROM mat_phy WHERE yearofstudy = 'Fourth'";
...
$queryassociate = "SELECT COUNT(*) AS associate FROM mat_phy WHERE yearofstudy = 'Third'";
...
$querycontiYearo = "SELECT COUNT(*) AS contiYearo FROM mat_phy WHERE yearofstudy = 'Second' OR yearofstudy = 'First'";
...
$queryconti = "SELECT COUNT(*) AS conti FROM mat_phy WHERE yearofstudy = 'Second'";
...
$queryyearo = "SELECT COUNT(*) AS yearo FROM mat_phy WHERE yearofstudy = 'First'";
    ...
    <div class="container">
      ...
      <main>
          ...
          <div class="sales">
            ...
            <div class="middle">
              ...
              <div class="progress">
                ...
                <div class="number">
                  <p><?php echo "$numOfMatPhy" ?></p>
                </div>
              </div>
            </div>

            <small class="text-muted">There are <b><?php echo "$numOfMatPhy" ?></b> Mat-Phy students currently registered for the examination</small>
          </div>
        ...
        <div class="recent-orders">
          <h2>Registered Mat-Phy Students</h2>
          <table>
            <thead>
              <tr>
                <th></th>
            ...
            <?php
              ...
              $sql = "SELECT * FROM  mat_phy LIMIT 0,5";
        ...
        <center>
          <div class="date">
            ...
            <span><a href="../admin/mat_phy.php"> <b>SHOW DETAILS</b> </a></span>
