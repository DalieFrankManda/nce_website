...
$queryHecAgr = "SELECT COUNT(*) AS totalHecAgr FROM hec_agr";
$queryTotalHecAgr = mysqli_query($connect, $queryHecAgr);
while($rowHecAgr = mysqli_fetch_assoc($queryTotalHecAgr)){
  $numOfHecAgr = $rowHecAgr['totalHecAgr'];
}

$queryfinaleSos = "SELECT COUNT(*) AS finaleSos FROM hec_agr WHERE yearofstudy = 'Fourth' OR yearofstudy = 'Third'";
...
$queryfinale = "SELECT COUNT(*) AS finale FROM hec_agr WHERE yearofstudy = 'Fourth'";
...
$queryassociate = "SELECT COUNT(*) AS associate FROM hec_agr WHERE yearofstudy = 'Third'";
...
$querycontiYearo = "SELECT COUNT(*) AS contiYearo FROM hec_agr WHERE yearofstudy = 'Second' OR yearofstudy = 'First'";
...
$queryconti = "SELECT COUNT(*) AS conti FROM hec_agr WHERE yearofstudy = 'Second'";
...
$queryyearo = "SELECT COUNT(*) AS yearo FROM hec_agr WHERE yearofstudy = 'First'";
  ...
  <body>
    <div class="container">
      <aside>
        <div class="top">
          <div class="logo">
            <img src="../images/NalikuleLogo.png" alt="Smart Bench Logo" />
      ...
      <main>
          ...
          <div class="sales">
            ...
            <div class="middle">
              ...
              <div class="progress">
                ...
                <div class="number">
                  <p><?php echo "$numOfHecAgr" ?></p>
                </div>
              </div>
            </div>

            <small class="text-muted">There are <b><?php echo "$numOfHecAgr" ?></b> Hec-Agr students currently registered for the examination</small>
          </div>
        ...
        <div class="recent-orders">
          <h2>Registered Hec-Agr Students</h2>
          <table>
            <thead>
              <tr>
                <th></th>
            ...
            <?php
              ...
              $sql = "SELECT * FROM  hec_agr LIMIT 0,5";
        ...
        <center>
          <div class="date">
            ...
            <span><a href="../admin/hec_agr.php"> <b>SHOW DETAILS</b> </a></span>
