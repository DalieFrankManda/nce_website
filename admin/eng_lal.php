...
$queryTotal = "SELECT COUNT(*) AS totalRegistered FROM eng_lal";
...
<body class="bg-info">
  ...
  <div class="container mt-5">
    ...
    <center>
        ...
        <h3 class="text-success"> <?php echo "$numOfStudents" ?> ENG-LAL REGISTERED STUDENTS</h3>
    </center>

    <a type="button" class="btn btn-secondary" href="../dashboard/engLal.php">BACK</a>
        ...
        $sql = "SELECT * FROM eng_lal ORDER BY regnum";
          ...
          while($row = $result->fetch_assoc()){
            ...
            <div>
                ...
                <center class='text-success'>
                    <a class='btn btn-warning btn-sm mt-2' href='eng_lal_update.php?id=$row[id]'>UPDATE</a>
                </center>
