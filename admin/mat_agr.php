...
$queryTotal = "SELECT COUNT(*) AS totalRegistered FROM mat_agr";
...
<body class="bg-info">
  ...
  <div class="container mt-5">
    ...
    <center>
        ...
        <h3 class="text-success"> <?php echo "$numOfStudents" ?> MAT-AGR REGISTERED STUDENTS</h3>
    </center>

    <a type="button" class="btn btn-secondary" href="../dashboard/matAgr.php">BACK</a>
        ...
        $sql = "SELECT * FROM mat_agr ORDER BY regnum";
          ...
          while($row = $result->fetch_assoc()){
            ...
            <div>
                ...
                <center class='text-success'>
                    <a class='btn btn-warning btn-sm mt-2' href='mat_agr_update.php?id=$row[id]'>UPDATE</a>
                </center>
