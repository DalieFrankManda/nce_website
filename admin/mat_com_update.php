    ...
    <div class="container p-5">
      <div class="p-3 border border-warning bg-secondary bg-light">
        ...
        if(isset($_GET['id'])){
            ...
            $query = "SELECT * FROM mat_com WHERE id = '$student_id'";
                    ...
                    <form action="reg_update_action.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3">
                            <select name="combi" class="form-select m-auto">
                                <option value="<?=$student['combi']; ?>"><?=$student['combi']; ?></option>
                        ...
                        <div class="mb-3">
                            <select name="yearofstudy" class="form-select m-auto">
                                <option value="<?=$student['yearofstudy']; ?>"><?=$student['yearofstudy']; ?></option>
                        ...
                        <center>
                            <button type="submit" name="mat_com_update" class="btn btn-secondary">SUBMIT</button>
                        </center>
                    </form>
