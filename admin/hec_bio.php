...
$queryTotal = "SELECT COUNT(*) AS totalRegistered FROM hec_bio";
...
<body class="bg-info">
  ...
  <div class="container mt-5">
    ...
    <center>
        ...
        <h3 class="text-success"> <?php echo "$numOfStudents" ?> HEC BIO REGISTERED STUDENTS</h3>
    </center>

    <a type="button" class="btn btn-secondary" href="../dashboard/hecBio.php">BACK</a>
        ...
        $sql = "SELECT * FROM hec_bio ORDER BY regnum";
          ...
          while($row = $result->fetch_assoc()){
            ...
            <div>
                ...
                <center class='text-success'>
                    <a class='btn btn-warning btn-sm mt-2' href='hec_bio_update.php?id=$row[id]'>UPDATE</a>
                </center>
